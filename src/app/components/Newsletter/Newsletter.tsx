...
export const Newsletter: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if ("id" in result) {
      // If 'id' property exists, it's a success response
  ...
  return (
    <div className="flex justify-between items-center gap-4 mt-4">
      <div className="flex flex-col gap-4 w-full xl:w-[50%] items-center">
        <h1 className="text-2xl sm:text-4xl md:text-8xl font-bold">
          Sign Up For The Newsletter
        </h1>
        <form
          onSubmit={handleSubmit}
          className="w-full flex flex-col gap-4 items-center mt-0 xl:mt-4"
        >
          <input
            type="email"
          ...
          />
          <button
            className="social-links flex justify-center w-full"
            type="submit"
            disabled={isSubmitting}
          >
            {/* Arrow icon */}
            ...
            >
              <path
                d="M9.96973 9.02588C9.96973 8.61167 10.3055 8.27588 10.7197 8.27588H14.2798C14.694 8.27588 15.0298 8.61167
              15.0298 9.02588V15.3519L13.7725 14.4895C13.0056 13.9633 11.9939 13.9633 11.227 14.4895L9.96973 15.3519V9.02588Z"
              />
              <path
                d="M12.5 2.15088C6.97715 2.15088 2.5 6.62803 2.5 12.1509C2.5 17.6737 6.97715 22.1509 12.5 22.1509C18.0228
      ...
      <div className="flex justify-center gap-12 border-2 p-18.5 w-full hidden xl:w-[50%] xl:flex">
        <div className="flex flex-col gap-4">
          ...
          <h1 className="font-bold text-xl">
            Weekly Dose of Deconstructed Code
          </h1>
          <p>
            Keep your coding knowledge sharp with a fresh delivery of my latest
            posts, featuring innovative solutions and clear concept
            deconstructions, arriving in your inbox each week.
          </p>
          <svg
            width="20"
            height="20"
          ...
          >
            <path
              d="M18.5 3.64062C18.799 3.64062 19.0844 3.69895 19.3454 3.80484L11.9299 11.2203L9.63761 8.92801C8.75893 8.04934
            ...
            />
            <path
              d="M20.4839 6.90924C20.7768 6.61634 20.7768 6.14147 20.4839 5.84858C20.191 5.55568 19.7162 5.55568
        ...
        <div className="flex flex-col gap-4">
          ...
          <h1 className="font-bold text-xl">
            The Month&apos;s Essential Code Recap
          </h1>
          <p>
            For a curated overview, subscribe to the monthly digest. It&apos;s a
            thoughtfully compiled recap of the most significant insights,
            detailed explanations, and standout discussions from the past four
            weeks.
          </p>
          <svg
            width="20"
