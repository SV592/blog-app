 ...
 return (
    <a href={url} target='_blank' className='cursor-pointer'>
      <div className='flex items-center justify-between border-b-2 p-2 w-full'>
        <div className='flex text-left items-center gap-2 flex-1 min-w-0'>
          <h1 className='font-bold hidden md:block flex-shrink-0'>#{num}</h1>
          <h1 className='truncate'>{title} - {artist}</h1>
        </div>
